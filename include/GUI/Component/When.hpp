...
namespace ui {
     ...
     * pointee should contain some kind of Property from which more components can be generated.
     */
    template<typename T>
    class When : public ForwardingComponent {
    public:
        When(PropertyOrValue<T*> pv)
    ...
    template<typename T>
    When(const Property<T*>&) -> When<T>;

    template<typename T, typename U, typename... Rest>
    When(DerivedProperty<T*, U, Rest...>) -> When<T>;
